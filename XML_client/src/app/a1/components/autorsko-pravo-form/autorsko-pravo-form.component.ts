...
export class AutorskoPravoFormComponent {
  ...
  private setValues() {
    ...
    if (this.zahtev.autorskoDelo.izvornoDelo === null || (this.zahtev.autorskoDelo.izvornoDelo.autor.ime === '' && this.zahtev.autorskoDelo.izvornoDelo.autor.prezime === ''))
    ...
    if (this.zahtev.autor.godinaSmrti === 0 || this.zahtev.autor.godinaSmrti == undefined)
      this.zivAutor = true
    if (this.zahtev.autorskoDelo.izvornoDelo!= null && (this.zahtev.autorskoDelo?.izvornoDelo.autor?.godinaSmrti === 0  || this.zahtev.autorskoDelo?.izvornoDelo.autor?.godinaSmrti == undefined))
  ...
  private setVrstaFormat() {
    if (this.zahtev.autorskoDelo.vrsta.value.toLowerCase() != 'ostalo') {
      const but = document.getElementById(this.zahtev.autorskoDelo.vrsta.value.toLowerCase().split('_')[0].trim()) as HTMLInputElement
      but.checked = true
    } else {
    ...
    if (this.zahtev.autorskoDelo.formatZapisa.value.toLowerCase() != 'ostalo') {
      const but = document.getElementById(this.zahtev.autorskoDelo.formatZapisa.value.toLowerCase().split('_')[0].trim()) as HTMLInputElement
      but.checked = true
    } else {
  ...
  changeDrugaFormaVisible(event: Event) {
    ...
    this.zahtev.autorskoDelo.formatZapisa.value = Object.keys(TFormatZapisa)[index]
