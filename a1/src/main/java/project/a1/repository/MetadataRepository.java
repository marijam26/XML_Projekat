...
import project.a1.util.SparqlUtil;
...
public class MetadataRepository {
    ...
    public void extractMetadata(ZahtevZaAutorskaDela zahtevZaAutorskaDela) throws IOException, JAXBException, TransformerException {
    ...
    public static void main(String[] args) throws JAXBException, IOException, TransformerException{
        ZahtevZaAutorskaDela ZahtevZaAutorskaDela = new MarshallingUtils().unmarshall("src/main/resources/data/autorsko_delo.xml");
